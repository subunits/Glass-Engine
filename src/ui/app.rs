...
pub fn App() -> impl IntoView {
    ...
    let query = move || RangeQuery {
        ...
        year_range:   year_range.get(),
        genre_filter: genre_filter.get(),
        top_k:        12,
        weights:      Dimensions::UNIT_WEIGHT,
    };

    let results = move || catalog.with_value(|c| c.search(&query()));
    let year_bounds = catalog.with_value(|c| c.year_bounds());
                ...
                <aside class="ge-sidebar">
                    ...
                    <div class="ge-genre-filter">
                        ...
                        <select on:change=move |ev| {
                            ...
                            set_genre_filter.set(if val == "all" { None } else {
